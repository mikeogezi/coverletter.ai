...
class Margins(object):
    def __init__(self, args=args):
        self._right = args.margin_right
        self._left = args.margin_left
        self._top = args.margin_top
        self._bottom = args.margin_bottom
...
class PDFCreator(object):
    ...
    def __init__(self, input_path, output_path, args=args, margins=margins):
        ...
        self.canvas = Canvas(output_path, pagesize=(pageWidth, pageHeight))
